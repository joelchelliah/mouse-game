 ...
 * Linearly interpolates between DEPTH_SCALE_TOP (y=0) and DEPTH_SCALE_BOTTOM (y=screenHeight).
 */
...
export const DEPTH_SPEED_SCALE_TOP = 0.2; // vertical speed multiplier at y = 0 (far away)
 ...
 * Objects further away (top) move slower vertically.
 */
